  ...
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div class="relative w-full max-w-md mx-4 bg-white dark:bg-[#1a1d26] rounded-2xl shadow-xl border border-slate-200 dark:border-white/5">
      ...
      <div class="flex items-center justify-between p-6 border-b border-slate-100 dark:border-white/5">
        <h2 class="text-lg font-black text-gray-900 dark:text-white">Create New User</h2>
        <button
          type="button"
          @click="close"
...
import type { RoleKey } from '@/modules/admin/types/admin.types'
...
interface Emits {
  (e: 'close'): void
  (e: 'submit', data: { name: string; email: string; role: RoleKey; password?: string }): void
}
